  ...
  return (
    <div className='bg-[#04233b]  text-white'>
        ...
        <div className='flex  flex-wrap justify-between py-16 items-start gap-10'>
          <div>
            ...
            <div className='mt-5 flex flex-col justify-start items-start gap-3'>
              <Link
                href={
                  'https://maps.google.com/maps?q=%20369/360,%20Shree%20ji%20Industrial%20Area,%20Kali%20Doongri,%20Madanganj%20Kishangarh+(My%20Business%20Name)'
                }
              ...
              <div className='flex gap-3 mt-5'>
                <Link href={'/'}>
                  <FaFacebookF className='text-[25px] hover:text-primary' />
                </Link>
                <Link href={'/'}>
                  <FaLinkedinIn className='text-[25px] hover:text-primary' />
                </Link>
                <Link href={'/'}>
                  <FaTwitter className='text-[25px] hover:text-primary' />
                </Link>
                <Link href={'/'}>
                  <FaInstagram className='text-[25px] hover:text-primary' />
                </Link>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='mt-5 flex flex-col justify-start gap-5'>
              <input
                ...
                className='outline-none py-4 bg-transparent placeholder-white border-b border-b-white'
              />
      ...
      <div className='bg-[#ffffff] '>
        <p className='text-[16px] text-[#04233b] text-center mx-4 py-6'>
          © 2024 All Rights Reserved By CB Machinery Solutions Pvt. LTD.
        </p>
      </div>
    </div>
  );
