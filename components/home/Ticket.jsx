    ...
    <div className='bg-[#F2FDFF] py-28'>
        ...
        <div className='flex flex-col md:flex-row gap-5  w-full'>
            <div className=' md:w-[40%] w-full flex flex-col justify-start items-start gap-5 '>
             <span className='text-[16px] font-Fjalla font-medium tracking-wide text-heading'>TICKET PACKAGES</span>
             <h2 className='text-[32px] text-primary font-Fjalla font-bold'>CHOOSE THE BEST PACKAGES FOR YOUR FAMILY</h2>
...
<div className='flex justify-center items-center border-b-2 border-body pb-3 '>                    <span className='text-[30px] font-Fjalla font-[400] text-heading'>$299.90</span><span className='text-[16px] text-white/85'>/family</span></div>
                    <div className='flex flex-col justify-center items-start gap-4'>
               <span className='flex justify-start items-center gap-3 text-[16px] text-white'><MdDone className='text-heading text-[20px] font-bold'/><p>All Access To Waterpark</p></span>
               <span className='flex justify-start items-center gap-3 text-[16px] text-white'><MdDone className='text-heading text-[20px] font-bold'/><p>Get Two Gazebo</p></span>
               <span className='flex justify-start items-center gap-3 text-[16px] text-white'><MdDone className='text-heading text-[20px] font-bold'/><p>
Free Soft Drinks</p></span>
               <span className='flex justify-start items-center gap-3 text-[16px] text-white'><MdDone className='text-heading text-[20px] font-bold'/><p>Get Four Lockers</p></span>
               <span className='flex justify-start items-center gap-3 text-[16px] text-white'><MdDone className='text-heading text-[20px] font-bold'/><p>Free Four Towels</p></span>
...
<div className='flex justify-center items-center border-b-2 border-body pb-3'>                    <span className='text-[30px] font-Fjalla font-[400] text-heading'>$59,90</span><span className='text-[16px] text-white/85'>/person</span></div>
                    <div className='flex flex-col justify-center items-start gap-4'>
