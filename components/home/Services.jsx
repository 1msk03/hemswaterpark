    ...
    <div className='flex flex-col lg:flex-row gap-16 w-full'>
      <div className='lg:w-1/2 w-full '>
       ...
       <div className='bg-primary/20 flex flex-col justify-center items-center gap-5 p-6'>
         ...
         <h3 className='text-[16px] font-Fjalla font-medium tracking-wide text-heading'>Private Gazebo</h3>
        ...
        <div className='bg-primary/20 flex flex-col justify-center items-center gap-5 p-6'>
         ...
         <h3 className='text-[16px] font-Fjalla font-medium tracking-wide text-heading'>Delicious Food</h3>
         <p className='text-[16px] text-body'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
        </div>
        <div className='bg-primary/20 flex flex-col justify-center items-center gap-5 p-6'>
            <div>
         ...
         <h3 className='text-[16px] font-Fjalla font-medium tracking-wide text-heading'>Safety Lockers</h3>
         <p className='text-[16px] text-body'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
        </div>
        <div className='bg-primary/20 flex flex-col justify-center items-center gap-5 p-6'>
            <div>
         ...
         <h3 className='text-[16px] font-Fjalla font-medium tracking-wide text-heading'>River Rides</h3>
         <p className='text-[16px] text-body'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
        </div>
       </div>
...
<div className='flex justify-between items-center border-b border-body py-3'>
    <h5 className= ' text-heading text-[16px] font-Fjalla tracking-wide font-normal'>Monday - Friday</h5>
...
<div className='flex justify-between items-center border-b border-body py-3'>
    <h5 className= ' text-heading text-[16px] font-Fjalla tracking-wide font-normal'>Saturday - Sunday</h5>
...
<div className='flex justify-between items-center border-b border-body py-3'>
    <h5 className= ' text-heading text-[16px] font-Fjalla tracking-wide font-normal'>Holiday</h5>
